...
%  \item  The SR2ML plug-in in its entirety will be made publicly available under the Apache version 2.0 license.
%
% REPLACE THIS ITEM WITH THE ONE ABOVE ONCE THE SR2ML GETS OPENSOURCE
%
...
%The SR2ML plug-in in its entirety will be made publicly available on an appropriate repository hosting site (e.g. GitHub).
