...
\newcommand{\aliasParameterDescription}[1]
{
...
\begin{itemize}
	\item \aliasParameterDescription{alpha}
	\item \aliasParameterDescription{beta}
\end{itemize}
...
\subsubsection{The Exponentiated Weibull Distribution}
The probability density function of the lognormal is given by
\begin{equation}
	f(t) =
\end{equation}
